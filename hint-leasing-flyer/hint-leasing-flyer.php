...
define( 'HLF_VERSION', '0.2.0-beta.2' );
...
require_once HLF_DIR . 'includes/class-hlf-image-url-guard.php';
require_once HLF_DIR . 'includes/class-hlf-image-search-provider-interface.php';
require_once HLF_DIR . 'includes/class-hlf-naver-image-search-provider.php';
require_once HLF_DIR . 'includes/class-hlf-image-search-service.php';
require_once HLF_DIR . 'includes/class-hlf-image-import-service.php';
