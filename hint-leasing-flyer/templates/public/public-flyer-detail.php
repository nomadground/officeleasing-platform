...
// 요청서: 관리비 0원은 "0만원(평당 0.0만원)"이 아니라 "포함"으로 표시만 바꾼다 — NOC 등 계산에는
// 실제 0 값을 그대로 쓰므로 이 표시 분기는 화면에만 영향을 준다.
...
$basic['주차']       = array( 'value' => hlf_format_parking( $item['parking_available'], $item['available_parking'], $item['total_parking'] ) );
